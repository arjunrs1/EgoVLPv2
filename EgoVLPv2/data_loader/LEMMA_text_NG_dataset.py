...
class LemmaTextNarrationGrounding(TextVideoDataset):
    ...
    def _get_caption(self, idx, sample):
        return sample['natural_language']
    ...
    def __getitem__(self, item):
        ...
        meta_arr = {'video_uid': hoi_index, 'hoi_index': hoi_index.item(), 'narration_uid': hoi_index, 'dataset': self.dataset_name}
        data = {'video': torch.zeros((16,3,224,224)), 'text': caption, 'meta': meta_arr}
        return data
