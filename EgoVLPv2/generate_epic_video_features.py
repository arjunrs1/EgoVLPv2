...
if __name__ == '__main__':
    ...
    """ 
    We need to produce features at the same hop length and stride as in CliMER. However, we don't have access to their feature generation code. We know that they compute a features every 1.875 seconds, whhich is 0.5333 seconds per feature,
    which corresponds to a feature every 32 frames. 
       """
